          ...
          <div class="carousel-item ">
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="offset-md-1 col-md-4 img-container">
                  <div class="img-box">
                    <img src="images/Online tech talks-pana.png" style="width: 103%;" alt="">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-5 offset-md-1">
                  <div class="detail-box">
                    ...
                    <div class="btn-box">
                      <a href="" class="btn-1">
                        Register for Our Next Bootcamp
                      </a>
                      <!-- <a href="" class="btn-2">
                        Courses
                      </a> -->
                ...
                <div class="offset-md-1 col-md-4 img-container">
                  <div class="img-box">
                    <img src="images/Online tech talks-amico.png" style="width: 103%;" alt="">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-7">
          <div class="detail-box">
            <div class="heading_container">
              <h2>
                Our Story: Empowering Tech Excellence
              </h2>
            </div>
            <p>
...
<!-- <section class="mission_vision_section layout_padding">
  <div class="container">
    ...
    <div class="row mission_vision_container">
      <div class="col-md-6">
        <div class="box">
          <div class="icon-box">
          ...
          <div class="detail-box">
            ...
            <p>
              Our mission is to empower individuals and organizations through innovative and accessible training solutions in DevOps, Cloud, and Fullstack Development. We are dedicated to fostering a learning environment that nurtures growth, creativity, and a deep understanding of cutting-edge technologies.
            </p>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="box">
          ...
          <div class="detail-box">
            ...
            <p>
              Our vision is to become a global leader in technical education, recognized for our commitment to excellence, inclusivity, and the success of our students. We strive to build a community of skilled professionals who drive the future of technology and innovation.
            </p>
          </div>
        </div>
      </div>
...
<!-- end category section -->
  ...
  <section class="info_section ">
    <div class="info_container layout_padding-top" style="padding-top: 1%;">
      <div class="container">
        <div class="info_top">
          <div class="info_logo">
  ...
  ">
        ...
        <a href="https://html.design/">Free Html Templates</a> and 
